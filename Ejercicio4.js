...
//let newProgramadores = [...programadores]
let newProgramadores = programadores.filter(programador => 
  programador.tareas.filter( tarea => getTiempo (tarea.tiempoDesarrollo)>25 ).length > 0);

  console.log(newProgramadores)