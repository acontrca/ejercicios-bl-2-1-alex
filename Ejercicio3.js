...
const nombre = 'Manuel'
const listEditTarea = ['Tarea 4.2', 'Tarea 4.3'];

let data = newProgramadores.find( programador => programador.nombre === nombre );
data.tareas.map( tarea => {
  if (listEditTarea.includes(tarea.nombreTarea)){
